...
export const MOCK_QUOTE_REQUESTS: QuoteRequest[] = [
  ...
  },
  {
    ...
    serviceType: "air",
    message: "Similar electronics air freight — previous lane quote.",
    status: "Quoted",
    quotedAmount: "₹25,000",
    submittedAt: isoDateTimeFromOffset(-14, 11, 0),
    quoteSentAt: isoDateTimeFromOffset(-14, 12, 0),
    quoteSentTo: "priya.sharma@techmahindra.com",
  },
  {
    id: "QW-2400",
    name: "Rahul Mehta",
