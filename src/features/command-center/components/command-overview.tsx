  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-6 xl:grid-cols-3">
        <div className="rounded-lg border border-border bg-card p-6 shadow-sm xl:col-span-2">
          <div className="mb-4 flex items-center justify-between">
            <h2 className="font-display text-lg font-bold">Shipment Volume</h2>
        ...
        <div className="rounded-lg border border-border bg-card p-6 shadow-sm">
          <h2 className="font-display mb-4 text-lg font-bold">Freight Mix</h2>
          <div className="h-56">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie
      ...
      <div className="grid gap-6 xl:grid-cols-5">
        ...
        <div className="rounded-lg border border-border bg-card p-6 shadow-sm xl:col-span-2">
          <h2 className="font-display mb-4 text-lg font-bold">AI Insights</h2>
