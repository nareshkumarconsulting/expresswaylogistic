...
export function TrackHero() {
  ...
  return (
    <section className="relative isolate overflow-hidden bg-brand pt-36 pb-24 text-brand-foreground md:pt-40 md:pb-28">
      ...
      <div className="container-page relative z-10">
        <div className="grid items-end gap-10 lg:grid-cols-12 lg:gap-12">
          <div className="lg:col-span-7">
            ...
            >
              Enter your ExpressWay tracking ID for live status, predicted ETA,
              and milestone history across air and ocean lanes.
            </motion.p>
