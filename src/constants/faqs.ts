...
export const ABOUT_PAGE_FAQS: FaqItem[] = [
  {
    ...
    answer:
      "ExpressWay Logistic (legal name Expressway Logistic Private Limited) is an Indian neutral NVOCC and freight forwarding company. Headquarters are in Noida, Uttar Pradesh. Leadership includes Sunil Kumar, CEO & Managing Director, and Joginder Singh, General Manager & Business Development Officer.",
  },
  {
